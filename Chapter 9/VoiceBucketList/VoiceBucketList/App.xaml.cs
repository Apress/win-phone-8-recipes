...
using VoiceBucketList.ViewModels;

namespace VoiceBucketList
{
    public partial class App : Application
    {
        private static BucketListViewModel viewModel = null;
        public static BucketListViewModel ViewModel
        {
            get
            {
                if (viewModel == null)
        ...
        {
            Uri vcdUri = new Uri("ms-appx:///MyVoiceCommands.xml");
