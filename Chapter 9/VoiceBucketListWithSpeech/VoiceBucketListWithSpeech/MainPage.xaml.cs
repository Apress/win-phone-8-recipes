...
namespace VoiceBucketList
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            else if (NavigationContext.QueryString.ContainsKey("clearHistory"))
            {
                //if another page was loaded as a result of a voice command and deep linking,
                //then be sure to clear the history when the user returns to this page
